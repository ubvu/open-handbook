...
- **`manuals/`** - Manuals to help researchers use specific tools 
...
- **`manuals/<tool>/_sidebar.yml`** - Specifies the order of the left sidebar of a specific tool manual 
...
├── manuals/<tool>/ - <tool> manuals
├── manuals/<tool>/index.qmd - Manual start page
├── manuals/<tool>/_sidebar.yml - Manual sidebar definition
