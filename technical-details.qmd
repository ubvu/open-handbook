...
The [easy GitHub contributor](https://github.com/apps/easy-github-contributor) is a small integration created by Liberate Science GmbH to make it easier to start contributing to the handbook. It is no longer maintained, an alternative will need to be implemented in the near future.
