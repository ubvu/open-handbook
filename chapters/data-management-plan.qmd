...
Data Management Plan (DMP) is a document outlining how research data will be handled throughout research lifecycle. A DMP is a structured way to address data collection, organization, storage, sharing, and preservation. It outlines the measures taken to ensure data security. DMP also address how data will be preserved and made available for future use.

## DMPonline

VU Amsterdam offers the online tool [DMPonline](https://dmponline.vu.nl/) for writing Data Management Plans. DMPonline is a platform that offers a range of templates, ensuring that researchers can create DMPs to meet the standards of diverse funders and institutions associated with their projects. The setup of DMPonline makes it easy to work on a DMP together with colleagues, advisors, or other stakeholders. VU Amsterdam researchers can use the request feedback function of DMPonline to get their DMP reviewed by a faculty data steward or RDM Support Desk colleague.
...
Various templates exist in which you can set up your DMP. We strongly recommend you to use the VU template, which is called `VU DMP template 2021 (NWO & ZonMw certified) v1.4`. Below is explained how to use this template. If you need to write a DMP for funding agencies NWO, ZonMw or ERC, you can use the VU template as well.
...
We recommend researchers to use the VU DMP template as much as possible. Using the VU template is particularly important for researchers who work with personal data, since it includes questions that serve as input for the GDPR record of processing activities. This means that writing a DMP and registering the personal data you use in your research are both covered when you write a DMP based on the VU DMP template. However, it is also possible to use other templates in DMPonline.

If your funder or partner organization requires you to use a certain template, it is possible to select that template in DMPonline. Please follow the steps below to select a funder's template.
...
If your research is subject to the (GDPR)[eventually link to a GDPR page], then you need to register information on your research in a central VU registry. This central registry lists all personal data processing activities carried out at the VU. The registry indicates why and how personal data are processed, and with whom they are shared. The registry helps organisations to demonstrate compliance with the GDPR and in the case of a data breach, the registry helps with monitoring and acting swiftly to inform all relevant stakeholders. 

For research projects, the VU registers data processing via [DMPonline](https://dmponline.vu.nl/). You can create your registration by logging into DMPonline and following the instructions under “Choose the right template”. Once you get to the two VU templates, you can fill in the VU DMP template if you need to write a DMP anyway and the information you include will be used for the registry. Alternatively, you can use the separate GDPR registration form if you don't need to write a (new) DMP. Your faculty's [Privacy Champion](https://vu.nl/en/employee/privacy-and-information-security/privacy-champions-information) can help you with your registration. 
