...
If you want to dynamically reuse content from the {{< var title >}}, you can do so using an HTML `iframe`. This post will help you through the steps to successfully embed a handbook page on a website you administer.
...
After you identified the page and possible anchor to embed, we can now move on to actually embedding it. Embedding the pages themselves is supported by all major browsers using the HTML element [`iframe`](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/iframe#loading).
...
You can find the [detailed code on how this page embeds the content, on GitHub](https://github.com/ubvu/open-handbook/blob/main/blog/2025-05-15embed-iframe.qmd#L43).

Thanks for reading and good luck creating your own embeds of the {{< var title >}} across VU Amsterdam pages 😊
