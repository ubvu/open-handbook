...
There are 2 basic ways to access Yoda data from a Mac: [Mounting the Yoda WebDAV interface in finder](#mounting-the-yoda-network-disk-in-finder) or via file transfer tools, in which case we recommend [Cyberduck](/manuals/yoda/data_transfer/yoda_using_cyberduck.qmd). Which one works best depends on your workflow.
...
4. Create a [Data Access Password](/manuals/yoda/data_access_password/yoda_dap.qmd) and copy it to the Password field. Tick the checkbox &ldquo;Remember this password
