...
title: Using WinSCP
categories: []
description: "This page explains how to use WinSCP as an alternative to the native WebDAV client."
---
...
4. You will be prompted for a name and password. User name is your email.  Create a [data access password](/manuals/yoda/data_access/yoda_dap.qmd) and copy it to the Password field.
