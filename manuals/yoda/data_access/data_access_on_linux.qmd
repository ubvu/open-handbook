...
3. You will be prompted for a name and password. Username is your email. Set a [Data Access Password](./yoda_dap.qmd) and copy it to the Password field.
...
4. First set a [Data Access Password](./yoda_dap.qmd).
