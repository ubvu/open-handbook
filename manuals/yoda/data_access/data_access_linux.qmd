...
3. You will be prompted for a name and password. Username is your email. Set a [Data Access Password](/manuals/yoda/data_access_password/yoda_dap.qmd) and copy it to the Password field.
...
4. First set a [Data Access Password](/manuals/yoda/data_access_password/yoda_dap.qmd).
...
is your [Data Access Password](/manuals/yoda/data_access_password/yoda_dap.qmd). External users have usually received their user name via email, along with a link to set their password. 
