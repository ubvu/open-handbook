...
categories: []
description: This page explains how to use Cyberduck together with Cryptomator to safely work with privacy sensitive data. 
This section explains how to use, install and create Cryptomator Vault. 
---
