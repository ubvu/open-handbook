...
categories: []
description: This page explains how to use Webdrive.
---
...
5. Enter the Username (an emailaddress). Create a [data access password](/manuals/yoda/data_access/yoda_dap.qmd) and copy it to the Password field.
