...
3. If the data manager encounters any issues, you will be contacted. Otherwise you'll receive a [notification](./yoda_notifications.qmd) that your data package has been published. This notification contains the DOI that has been assigned to your data package.
