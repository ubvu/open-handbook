...
After archiving your data, you can optionally [publish it](/manuals/yoda/securing_distribution/yoda_workflow_vault_publish.qmd), making your dataset findable on the internet. If you classify your data as **open - freely retrievable**, then the data itself can be downloaded anonymously by any third party.
