...
- Clicking on the DOI link will lead the visitor to a "landing page" which shows the metadata, for example [https://publication.yoda.vu.nl/full/VU01/IREC95.html](https://publication.yoda.vu.nl/full/VU01/IREC95.html)
    - If the Access Type metadata field is set to &ldquo;Open - Freely retrievable&rdquo;, the data in the data package is downloadable from the landing page via "View contents", for example [an Open data package](https://publication.yoda.vu.nl/full/VU01/IREC95.html) 
    - If the Access Type metadata field is set to &ldquo;Restricted&rdquo; or &ldquo;Closed&rdquo;, only the metadata will be shown, for example [a Restricted data package](https://publication.yoda.vu.nl/full/VU01/F5HUM4.html) and [a Closed data package](https://publication.yoda.vu.nl/full/VU01/Y1C8O0.html)
