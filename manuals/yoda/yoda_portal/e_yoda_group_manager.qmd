...
The added user will receive an [invitation](./yoda_access.qmd) to join the connected SRAM collaboration. Most users will be able to log in with their own institutional account, if their institute is not connected to SRAM they need to create an **eduID (NL)** account.
