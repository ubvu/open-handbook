...
- For all cases you need to supply a suitable license which details the terms and conditions under which your data can or cannot be used. See [this page for more information on suitable licenses](./yoda_license.qmd). 
