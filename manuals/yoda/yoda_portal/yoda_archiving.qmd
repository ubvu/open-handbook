...
After archiving your data, you can optionally [publish it](./yoda_publishing.qmd), making your dataset findable on the internet. If you classify your data as **open - freely retrievable**, then the data itself can be downloaded anonymously by any third party.
...
![CheckforCompliance2](/public/manuals/yoda/arch-compliance-dans.png)
...
[the metadata form of the folder](./yoda_metadata.qmd).
