...
### Commandline
If you are familiar with commandline tools [rclone](./yoda_using_rclone.qmd) is also a good option to access the Yoda Network disk via Webdav. It also provides the option to use a drive letter.