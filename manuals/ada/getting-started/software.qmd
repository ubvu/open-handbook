...
ADA ships a curated, architecture-optimized software stack via Lmod modules. The stack follows an annual release (for example `2025`) that bundles compilers, MPI, and libraries maintained by ITvO.
...
Review the upstream [Pixi quick start guide](https://pixi.dev/docs/python/getting-started/) to see typical workflows and commands before building environments on ADA.
:::
...
- [Getting started with Pixi for Python](https://pixi.dev/docs/python/getting-started/)
