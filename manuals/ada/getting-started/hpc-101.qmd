...
date: last-modified
---
This page offers a short explanation of essential concept in High Performance Computing.
...
When a program is handled concurrently, it is **not necessarily a parallel program**. Instructions can also make use of time-sharing (sharing a single CPU core).
