...
You can use any SSH client to login at `<VUNETID>@ada.labs.vu.nl`. Example clients are [Windows Subsystem Linux](https://learn.microsoft.com/en-us/windows/wsl/) (Windows), [MobaXterm](https://mobaxterm.mobatek.net/) (Windows) and [iTerm2](https://iterm2.com/) (macOS).
...
4. Go to â€œNetwork settingsâ€ and click SSH gateway (jump host)
