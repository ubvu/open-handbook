...
## Configuration
To use iCommands, a [configuration file](/manuals/yoda/data_access/yoda_using_icommands.qmd#configuration) is required in your home directory. This file contains the necessary connection settings for accessing Yoda.

## Basic iCommands
First use the `iinit` command to connect. You will need a Yoda [Data Access Password](/manuals/yoda/data_access/yoda_dap.qmd). 
