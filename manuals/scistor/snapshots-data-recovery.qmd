...
📧 [itvo.it@vu.nl](mailto:itvo.it@vu.nl)

---

## Windows (Difficulty: Easy)

If you don't have access to a Windows machine, connect to [Azure Virtual Desktop (AVD)](https://windows.cloud.microsoft/spa-signin-oidc#/devices) and follow the instructions for mounting a share in Windows.
...
> **Note:** This folder is protected and cannot be listed with `ls -la` or accessed through Finder, even with ⌘+G.
