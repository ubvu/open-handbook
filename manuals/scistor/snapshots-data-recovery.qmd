...
If you don't have access to a Windows machine, connect to [Azure Virtual Desktop (AVD)](https://windows.cloud.microsoft/spa-signin-oidc#/devices) and follow the [instructions](/topics/scistor.qmd#windows) for mounting a share in Windows.
