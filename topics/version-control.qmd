...
Additionally, the University Library includes material on Git in their Software Carpentry courses. In those courses, learning Git is combined with learning a programming language (Python or R). Would you like to know more about these workshop sessions, when they take place, and how you can attend? Get in touch with the [RDM Support Desk](mailto:rdm@vu.nl).
