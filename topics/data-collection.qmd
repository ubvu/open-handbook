...
Data collection may consist of the re-use of existing data and/or the generation of new data. You can find more specific information on the re-use of existing data on the [Finding Existing Data](https://libguides.vu.nl/researchdata/finding-existing-data) page in this LibGuide
...
* [Documentation](https://libguides.vu.nl/rdm/data-documentation) & [metadata](https://libguides.vu.nl/rdm/metadata)
* [Storage](https://libguides.vu.nl/rdm/data-storage) & [protection](https://libguides.vu.nl/rdm/data-protection)

This relates to the Reproducibility of your research according to the [FAIR-data principles](https://libguides.vu.nl/rdm/overview#s-lg-box-wrapper-17896126).
