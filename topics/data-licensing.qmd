...
In [DataverseNL](/tools/dataversenl/index.qmd) you can choose your terms of use when uploading data to the repository. The [DataverseNL user guide](https://guides.dataverse.org/en/latest/user/dataset-management.html#terms) explains how licensing works in the repository.

### Yoda

If you publish your data in Yoda, there is [guidance](/tools/yoda/workflow_metadata_licence.qmd) available on how to choose a licence and how to customise licences. 
