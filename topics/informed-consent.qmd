...
categories: [Policies and Legislation]
---

Processing personal data, i.e. data about human beings, see [General Data Protection Regulation](../topics/gdpr.qmd) (GDPR), requires a legal ground. One of the most common legal grounds used in scientific research is asking participants for their consent. 
...
Note that a [VU Informed Concsent Form (ICF) generator](https://icfg.rshiny.labs.vu.nl/) is available, which can help you in drawing up an informed consent form. The Faculty of Behavioural and Movement Sciences has a [GDPR Checklist for Informed Consent](https://fgb-rdm.nl/legal/ICFChecklist.html). You can use these resources when you prepare your consent form, but always make sure to discuss your consent form with your [ethics committee](../topics/ethical-review.qmd) and 🔒 [Privacy Champion](https://vu.nl/en/employee/policy-and-organisation/privacy-champions-information), so that it aligns with faculty guidelines and the specific requirements for your study.

## Support in your faculty: Privacy Champions

Each faculty has one or more Privacy Champions, who are the first point of contact for questions relating to privacy and the GDPR. The Privacy Champions can help you with completing a Data Protection Impact Assessment, registering your research in the record of processing activities, designing informed consent forms and other questions relating to the GDPR. The 🔒 [list of Privacy Champions](https://vu.nl/en/employee/policy-and-organisation/privacy-champions-information) can be found on the VU website.
