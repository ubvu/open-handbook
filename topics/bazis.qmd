...
1. Point the cluster to the Yoda server by creating a file called `.irods/irods_environment.json` in this folder. The file should look like this, replacing <YOUR-VUNETID> with your VUnetID:
   ...
   ```
   {
      ...
      "irods_port": 1247,
      "irods_home": "/vu/home",
      "irods_user_name": "<YOUR-VUNETID>@vu.nl",
      "irods_zone_name": "vu",
...
This will show you the contents of your home directory on Yoda. The project folder you have access to is located at `/vu/home`.
