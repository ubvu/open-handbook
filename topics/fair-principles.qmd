...
A DMP is a living document in which you specify what kinds of data you will use in your project, and how you will process, store and archive them. Preparing a data management plan should be your first step in the process to make data FAIR. The DMP template will ask questions that enable you to systematically address the things that need to be done to make your data FAIR. Writing a [DMP](/topics/data-management-plan.qmd) is also a requirement from funding agencies and some faculties at VU Amsterdam. At VU Amsterdam, you can use [DMPonline](https://dmponline.vu.nl/?perform_check=false) to create and share DMPs.
...
- [DataverseNL](/tools/dataversenl/index.qmd)
- [Yoda](/tools/yoda/index.qmd)
