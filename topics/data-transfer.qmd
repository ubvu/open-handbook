...
This page provides tips on collecting and transferring data, but this is of course only a part of Data Management. Even if a formal [Data Management Plan (DMP)](./data-management-plan.qmd) is not strictly required, it is still good practice to have a plan on how to handle your research project's data from start to end. Always ensure you are informed on any [legal and ethical requirements](https://rdm.vu.nl/topics/data-management-plan.html#legal-and-ethical-requirements) for your research data.
...
Make a plan for managing data on the measurement device. Make sure a copy, and backup is made before deleting data from the device itself.   
...
Which tools work best is highly dependent on the source and target storage platforms. Contact [IT for Research](./itvo.qmd) for advise, they can also setup a temporary server for the transfer.
