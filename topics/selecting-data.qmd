...
![A Scriberia illustration showing storage on the left, in a kitchen space with storage making things available, and archiving on the right, in a museum where it is available for viewing.](https://libapps-eu.s3.amazonaws.com/accounts/144379/images/storage-archiving.jpg)
...
* [Project documentation](./data-documentation.qmd#pro)
* [Codebook](./data-documentation.qmd#codebooks) or [protocol](./data-collection.qmd#data-collection-protocols)
...
See the topic [Metadata](./metadata.qmd) for more information about documenting your data.
