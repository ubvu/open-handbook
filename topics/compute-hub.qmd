...
## What is it?
The [VU Compute Hub](https://hub.compute.vu.nl) is a [JupyterHub](https://jupyter.org/hub) instance hosted by IT at the VU. It allows you to run a number of common analysis tools on a server. The Hub is mainly aimed at providing environments for student courses, but is available for VU Researchers as well.
