...
* **[SciStor](/tools/scistor/index.qmd)** is **networked** storage hosted by IT for Research (ITvO) suitable for large volumes of (sensitive) data. With SciStor you have fast access to your data on campus, the [ADA high performance compute cluster](/tools/ada/index.qmd) and [SciCloud servers](/tools/scicloud/index.qmd.qmd), but it can't be used for external collaboration.

* **[Yoda](/tools/yoda/index.qmd)** is a **cloud** storage platform at SURF (Dutch IT cooperative of education and research) and is suitable for storing small to very large volumes of (sensitive) data. Yoda supports external collaboration. It has an integrated archiving and publishing facility, making it a one-stop platform. 

* **[SURF Research Drive](/tools/researchdrive/index.qmd)** is a **cloud** storage platform at SURF for research projects suitable for storing small to medium (~10TB) volumes of (sensitive) data. Research Drive supports external collaboration. It offers a sync client for easier up- and downloading of data.

* **[OSF](/tools/osf/index.qmd)** is an online platform especially suitable for small data volumes that you want to share with the public during the research project.
