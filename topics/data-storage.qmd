...
* **[SciStor](../topics/scistor.qmd)** is **networked** storage hosted by IT for Research (ITvO) suitable for large volumes of (sensitive) data. With SciStor you have fast access to your data on campus, the [ADA high performance compute cluster](/tools/ada/index.qmd) and [SciCloud servers](/tools/scicloud/index.qmd.qmd), but it can't be used for external collaboration.
