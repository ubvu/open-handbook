...
* **[SciStor](./scistor.qmd)** is **networked** storage hosted by IT for Research (ITvO) suitable for large volumes of (sensitive) data. With SciStor you have fast access to your data on campus, the [ADA high performance compute cluster](./ada.qmd) and [SciCloud servers](./scicloud.qmd), but it can't be used for external collaboration.

* **[Yoda](./yoda.qmd)** is a **cloud** storage platform at SURF and is suitable for storing small to very large volumes of (sensitive) data. Yoda supports external collaboration. It has an integrated archiving and publishing facility, making it a one-stop platform. 

* **[SURF Research Drive](./researchdrive.qmd)** is a **cloud** storage platform at SURF for research projects suitable for storing small to medium (~10TB) volumes of (sensitive) data. Research Drive supports external collaboration. It offers a sync client for easier up- and downloading of data.

* **[OSF](./osf.qmd)** is an online platform especially suitable for small data volumes that you want to share with the public during the research project.
