...
- Running a desktop environment with analysis tools, use your favorite desktop tools on an environment with more performance. Unlike [SciCloud][./scicloud.qmd] GPU resources are available. You can easily connect an environment to your data on Research Drive or Yoda.
...
- If for whatever reason your application for this grant is denied, you could also claim credits from the VU [Research Capacity Computing Service contract with SURF](https://www.surf.nl/research-capacity-computing-service-rccs-directe-toegang-tot-onze-rekensystemen-en-expertise) contract. Please contact [IT for Research](mailto:itvo.it@vu.nl) for details on how to obtain these credits.
