...
- Growing catalog of pre-built application environments, allowing an easy install.
- Easy connection to your data on [Research Drive](researchdrive.qmd), Yoda will follow soon.
...
- Pay for what you use, inactive systems incur no cost.
...
- First apply for a new Collaboration by logging in to [SRAM](https://sram.surf.nl) and clicking the "Request a new collaboration" button. <!-- I need to check this with a normal account and make screenshots -->.

- The SRAM admins at IT for Research (ITvO) will contact you to discuss your specific needs.

- Once the Collaboration request is approved you can connect the Research Cloud Application Service <!-- What is this called again? --> to the new collaboration.
...
Once the request is granted you will have access to a _wallet_ in Research Cloud and can start an environment.
