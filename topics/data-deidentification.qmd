...
Regardless of whether you fully anonymise the data or not, even a basic level of data de-identification, such as removing names and contact information from a dataset, has important advantages. De-identification helps you to:
...
Acknowledgement: This text is based on the Data Privacy Handbook of Utrecht University [@data-privacy-handbook-uu] and the [FGB (VU Faculty of Behavioural and Movement Sciences) Security Tips](https://fgb-rdm.nl/Security/Deidentification.html). We thank our colleagues for creating and sharing their work.
