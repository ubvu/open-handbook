...
Note that there is a free community partition available on the [VU HPC cluser BAZIS](./bazis.qmd), where you can refine your analysis scripts before running them on the more expensive Snellius cluster. Experts at [IT for Research](mailto:itvo.it@vu.nl) can help you optimise your code to run more efficient. 
