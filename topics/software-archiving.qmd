...
At VU Amsterdam, we strive to make our research software [FAIR](../topics/fair-principles.qmd). When research software is archived in a repository provided by VU Amsterdam ([Yoda](  /tools/yoda/index.qmd) or [DataverseNL](../topics/dataversenl.qmd)), the following requirements apply:
