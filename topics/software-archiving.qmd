...
At VU Amsterdam, we strive to make our research software [FAIR](../topics/fair-principles.qmd). When research software is archived in a repository provided by VU Amsterdam ([Yoda](/tools/yoda/index.qmd) or [DataverseNL](/tools/dataversenl/index.qmd)), the following requirements apply:
...
- **[Yoda](/tools/yoda/index.qmd)**: For data and software associated with research; note that this is not by default publicly accessible.
