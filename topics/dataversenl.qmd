...
All VU employees can create an account in DataverseNL and upload and publish datasets. When you wish to upload data to DataverseNL, it is important to select your faculty or department. If you want to upload your dataset as part of a certain department, and your department is not yet included in DataverseNL, you can contact the DataverseNL manager to request your department to be added.

### Viewing and reusing data

DataverseNL is available for everyone. Anyone can gain access to the datasets by creating an account in DataverseNL, unless the dataset contains restricted files. In this case the contact person for the dataset needs to grant access in order for others to use the data.
