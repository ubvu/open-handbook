...
- The VU Research Information System PURE uses the [CERIF metadata standard](https://eurocris.org/services/main-features-cerif) 
...
[comment]: # (codebook url missing)
[comment]: # (Something to think about..I am afraid I am missing in this section the connection and the use of the terms "controlled vocabularies & ontologies". The title of this section is Controlled Vocabularies and Classification. For a researcher who is not familiar with these terms, I am afraid they do not know that a controlled term can be from a term list, while an ontology is a structured classified term. Thus it may be sometimes confusing to read only the term "controlled vocabulary", at some point in the text only read the term "ontology", or read the sentence "controlled vocabularies and ontologies". Thus the question a researcher might have is "are these two terms interchangeable?")

[comment]: # (perhaps worth to mention the OntoPortal as a resource in this page?)
...
[comment]: # (an example of how a metadata file would look like?)
...
* The VU Research Portal [PURE](../guides/publish-and-share.qmd#register-your-dataset-in-pure) uses the [CERIF](https://eurocris.org/services/main-features-cerif) metadata standard
