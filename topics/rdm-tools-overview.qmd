...
DMPonline is VU's institutional platform for creating Data Management Plans with templates certified or provided by major funders (NWO, ZonMw, ERC). Free access with VU credentials.
...
Integration pathways: DMPonline uses Single Sign-On to log in with your VUnetID, but there are no other integrations with VU services.
More information about DMPonline can be found on the [dedicated page](/topics/dmponline.qmd)
Support structure: [Contact](mailto:rdm@vu.nl) the RDM Support desk for questions.

### Qualtrics

Advanced cloud-based survey platform with file upload capabilities and API integration. 

Tool selection guidance: Qualtrics is the most elaborate VU supported service for creating research surveys. The only other supported tool is [MSforms](https://www.microsoft.com/en-us/microsoft-365/online-surveys-polls-quizzes), which can also be used for *non-research* surveys.
...
More information about Qualtrics is available on the [dedicated page](/topics/qualtrics.qmd) and in the [FAQ](/manuals/qualtrics/qualtrics-faq.qmd)
Support structure: [Contact](mailto:rdm@vu.nl) the RDM Support desk for questions.

### Transcript Online & Amberscript

Transcript Online and Amberscript are both speech-to-text transcription services. VU Amsterdam has a processing agreement with both, so using them as a VU employee is permissible under the GDPR. However, any costs need to be covered from the project budget.
Tool selection guidance: This depends on the transcription needs and the budget
Cost transparency: costs are detailed on the [page about Amberscript and Transcript Online](https://vu.nl/en/about-vu/divisions/university-library/more-about/transcription-at-vu-for-audio-and-video-files)
Integration pathways: You can log into Amberscript using Single Sign-On, but there is no integration (for either) with other VU services.
More information about both of them may be found on the [page about transcription services at the VU](https://vu.nl/en/about-vu/divisions/university-library/more-about/transcription-at-vu-for-audio-and-video-files)
Support structure: [Contact](mailto:rdm@vu.nl) the RDM Support Desk for questions.

### Atlas.TI

Atlas.TI is a tool for qualitative data analysis, often used for the qualitative analysis of texts. Among other features, you can attach codes to parts of the text.

Tool selection guidance: Atlas.TI is the only qualitative data analysis software currently offered at VU.
Cost transparency: Atlas.TI is provided free of charge to all VU researchers and students as part of the university's research infrastructure and support services. That said, there is a limited number of Atlas.TI licences available as part of the campus licence and it happens occasionally that IT requests inactive users to relinquish their licence.
Integration pathways: Use your VU or ACTA email to create an account for Atlas.TI, **but create a password that is different from your VU/ACTA password**. There are no integrations with other VU services.
Support structure: [Contact the IT Servicedesk](servicedesk.it@vu.nl) for questions.
