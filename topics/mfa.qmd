...
Please note that when using a YubiKey, you can only log in on devices with a USB port (such as laptops or desktops), or devices with NFC chips (many smartphones).
