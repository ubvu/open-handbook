...
![An image layering five different kinds of metadata, with the FAIR principles on the outside, followed by discipline metadata standards, project documentation, metadata data set, and metadata data object.](https://libapps-eu.s3.amazonaws.com/accounts/62029/images/Metadata.png)
...
1. [FAIR data principles](./fair-principles.qmd): the set of principles (Findable, Accessible, Interoperable, Reusable) for data exchange.
2. Disciplinary [metadata standards](./metadata.qmd): guidelines for documenting data. This can refer to the dataset documentation, the object description, or both. Disciplinary metadata standards can document the dataset as a whole or as a data object (see number 5).
...
4. [Metadata dataset](./metadata.qmd#metadata--datasets): the description of a dataset, often used for discovering datasets within a repository.
