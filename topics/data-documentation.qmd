...
1. [FAIR data principles](../topics/fair-principles.qmd): the set of principles (Findable, Accessible, Interoperable, Reusable) for data exchange.
2. Disciplinary [metadata standards](../topics/metadata.qmd): guidelines for documenting data. This can refer to the dataset documentation, the object description, or both. Disciplinary metadata standards can document the dataset as a whole or as a data object (see number 5).
...
4. [Metadata dataset](../topics/metadata.qmd#metadata-datasets): the description of a dataset, often used for discovering datasets within a repository.
