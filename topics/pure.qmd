...
Access to Pure is automatically provided to all VU Amsterdam researchers and basic profiles are usually pre-populated with HR information. No additional request process is required.
...
3. **Explore your workspace**: Familiarise yourself with the main navigation and sections
...
- **ORCID integration**: [Link your ORCID profile](https://libguides.vu.nl/orcid/register) to synchronise your ORCID with your PURE profile.

#### Professional information
- **Affiliations**: Confirm faculty and department associations
- **Research groups**: Add membership of research groups and centres
...
- **Software registration**: Record research software and tools you have developed
