...
* Persistent Identifier: Unique identifier, most common is the DOI (see section [Data Publication](https://libguides.vu.nl/rdm/data-publication)).
...
Relevant is also the [Citation File Format (CFF)](https://ubvu.github.io/open-handbook/topics/cff.html).
