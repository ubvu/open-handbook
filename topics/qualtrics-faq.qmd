...
A2: Security settings are in place which set an user account to [Status: Disabled] when a certain inactivity threshold is reached. A disabled account status does not affect its data. Please contact the RDM Support Desk at (rdm@vu.nl) to have your accounts re-enabled.</br>
