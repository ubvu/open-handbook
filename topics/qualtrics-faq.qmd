...
A1: Other login method than [Vrije Universiteit SSO] is been used. Go to the [login page](https://vuamsterdam.eu.qualtrics.com), choose: [Vrije Universiteit SSO] and log in with your VU account credentials (e-mail address and password). See also [Creating and Accessing User Accounts](https://rdm.vu.nl/topics/qualtrics.html#creating-and-accessing-user-accounts)<br />

<br />
[Q2] I cannot login, I received an error message “account is disabled”. How do I access my account?

A2: Security settings are in place which set an user account to [Status: Disabled] when a certain inactivity threshold is reached. A disabled account status does not affect its data. Please contact the RDM Support Desk at [rdm@vu.nl](rdm@vu.nl) to have your accounts re-enabled.
