# Data Documentation
By creating documentation about your research data you can make it easier for yourself or for others to manage, find, assess and use your data. The process of documenting is also known as the proces of describing. The documentation or descriptions are also referred to as metadata, i.e. data about data. These metadata can take various forms and can describe data on different levels.
...
More information can be found in the section about the [FAIR data principles](https://ubvu.github.io/open-handbook/topics/fair-principles.html).

## Unstructured metadata
Unstructured metadata is mainly intended to provide more detailed information about the data and is primarily readable for humans. The type of research and the nature of the data influence what kind of unstructured metadata is necessary. Unstructured metadata is attached to the data in a file. The format of the file is chosen by the researcher. 

### README
A README file provides information about data and is intended to help ensure that data can be correctly interpreted, by yourself or by others. A README file must be submitted along with the data.
...
## Structured metadata
Structured metadata is intended to provide information in a standardized way. The structured metadata is readable for both humans and machines. It can be used by data catalogs, for example DataCite Commons. 

The standardization of metadata involves the following parts:
...
Many examples of vocabularies and classification systems can be found at the [FAIRsharing.org website](https://fairsharing.org/). It has  a large list for multiple disciplines. If you are working on new concepts or new ideas and are using or creating your own ontology/terminology, be sure to include them as part of the metadata documentation in your dataset (for example as part of your codebook).

{{< include ../topics/persistent-identifier.qmd >}}

### Metadata levels
Finally a distinction can be made on the level op description. Metadata can be about the data as a whole or about part of the data. It can depend on the research domain and the tools that are used on how many levels the data can be described. In repositories like Yoda and DataverseNL it is common practice to only create structured metadata on the level of the data as a whole. 
