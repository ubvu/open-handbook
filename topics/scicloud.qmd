...
<!--
## Use-cases of SciCloud
Applications you want to run 24/7, for example:
- Running a custom web service or application. For example a chatbot or linked data experiment.
- Hosting a licensed server application for your group.
...
After you have requested a SciCloud virtual server, one of the IT for Research employees will schedule an interview to discuss ypur wishes and the cost. 

Purchase of virtual server capacity takes place according to standard building blocks, so that the server capacity is used optimally. This means that combinations of the following two options can be purchased: 
