...
## Storage 
By default, the virtual server is provided with 30 GB of storage capacity. Do you need more storage? Then a link with [SciStor](./scistor.qmd) storage is a possibility providing access to fast networked storage. ITvO can advise on this.
