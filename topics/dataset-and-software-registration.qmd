...
3. You can fill in the form using the following manuals and read more about the various metadata in use (generic and subject specific):
    *  [dataset manual (NL)](../public/Registreer_Datasets_in_Pure.pdf)/[dataset manual (EN)](Register_Datasets_in_Pure.pdf)
    *  [software manual (EN)](Register_Software_in_Pure.pdf)
