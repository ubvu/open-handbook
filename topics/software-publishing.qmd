...
Repositories provided by VU Amsterdam ([Yoda](https://publication.yoda.vu.nl/) and [DataverseNL](https://dataverse.nl/dataverse/vuamsterdam)) will generate a [Persistent Identifier](../topics/persistent-identifier.qmd) for your software and they will ask you to fill out [metadata](../topics/metadata.qmd) fields. In this way, they contribute to making your software findable. This will also be the case for external trusted repositories (such as [Zenodo](https://zenodo.org/)).
...
As mentioned above, software publishing must happen through a repository. These can be provided by the VU Amsterdam such as ([Yoda](https://publication.yoda.vu.nl/), [GitLab](https://git.vu.nl/), and [DataverseNL](https://dataverse.nl/dataverse/vuamsterdam)) or third parties like [Zenodo](https://zenodo.org/), [OSF](https://osf.io/), [Codeberg](https://codeberg.org/), and [Github](https://github.com). Some of these provide an integrated option to get a DOI for your software or have documentation on how to include one within their recommended workflow.
