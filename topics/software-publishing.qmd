...
As mentioned above, software publishing must happen through a repository. These can be provided by VU Amsterdam such as ([Yoda](../topics/yoda.qmd), [GitLab](https://git.vu.nl/), and [DataverseNL](../topics/dataversenl.qmd)) or third parties like [Zenodo](https://zenodo.org/), [OSF](https://osf.io/), [Codeberg](https://codeberg.org/), and [Github](https://github.com). Some of these provide an integrated option to get a DOI for your software or have documentation on how to include one within their recommended workflow.
