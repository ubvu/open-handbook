...
Yoda presents researchers a comfortable, easy-to-use solution for the safe storage, sharing and organisation of research data that follows internationally accepted [FAIR](../topics/fair-principles.qmd) data principles. Something increasingly demanded by both their institutions and funding organisations (such as the NWO).
...
[Yoda is open source software](https://github.com/UtrechtUniversity/Yoda) developed and maintained by Utrecht University for the Yoda Consortium, of which the VU is a member.
