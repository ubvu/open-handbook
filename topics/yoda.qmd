...
## Access to Yoda
Yoda is available for every VU researcher. If you need project space to store data for your research project, you can [request it via a form](https://Yoda.vu.nl/getting-started/requesting-space.html).

Once the project space has been created you can start to invite your collaborators.

## Getting Started
The VU Yoda website has practical information on the use of the Yoda for users [starting with Yoda](https://Yoda.vu.nl/getting-started/index.html). 
