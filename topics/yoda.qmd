...
Yoda is available for every VU researcher. If you need space to store data for your research project, you can [request it via the linked form](https://yoda.vu.nl/site/getting-started/requesting-space.html). If you are an external VU researcher (without a VUnetID), please contact your faculty data steward; you will require the assistance of the faculty data steward who can apply for project space on your behalf.
