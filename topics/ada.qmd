...
At the moment the community partition does not include GPU resources. If you have tasks that need a GPU (such as Machine Learning) you can apply for access to the national HPC infrastructure [Snellius](./snellius.qmd) or consider [buying ADA compute nodes](#buying-dedicated-compute-nodes). 
