...
![Research cycle diagram showing where preregistration fits within the theory–data cycle. Figure adapted from Morling & Calin-Jageman (2020).](public/Preregistration-can-be-added-as-a-step-in-the-theory-data-cycle-Here-preregistration-is.png)
...
The Open Science Framework (OSF), developed by the Center for Open Science (COS), provides an online infrastructure for managing, documenting, and sharing research projects and associated research data. It supports collaboration and transparency by enabling researchers to organize project components, data, and documentation in a centralized environment. COS has compiled a [list](https://osf.io/e6auq/wiki?wiki=6h2fw) of examples of preregistration studies across various disciplines. 
