...
While originally developed for Indigenous data, the CARE principles have broader applicability to research involving any communities or populations, particularly those that have been historically marginalized or disadvantaged. They emphasize community engagement, ethical responsibility, and the importance of ensuring that data use benefits the communities from which data originates.
...
### Collective Benefit
- **Community value creation**: Data ecosystems should be designed to support Indigenous communities' self-determination and collective benefit
- **Inclusive development**: Data should support Indigenous innovation and generate value for Indigenous communities
- **Equitable outcomes**: Data use should promote equitable outcomes for Indigenous peoples and communities
- **Community priorities**: Data governance should align with Indigenous community values, priorities, and worldviews
- **Sustainable development**: Data practices should contribute to sustainable development that benefits Indigenous communities
