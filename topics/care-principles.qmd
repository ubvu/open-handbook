...
Library (special) collections may also require some care, especially if researchers would like to use them. At the 2025 LIBER Conference in Lausanne (Switzerland) a roundtable comprising of librarians who specialise in Indigenous Knowledges and/or had an Indigenous background discussed the ways libraries can incorporate Indigenous Knowledges and collections in their services while taking the CARE principles into account. The roundtable highlighted limited awareness among library staff that collections may be problematic, the fact that Indigenous Peoples may historically not have been included in libraries' collection development and collection access, and the situation that library catalogues may contain terms and descriptions that are inaccurate, offensive and harmful.
To partially address that latter issue, the VU University Library started a [project](https://vu.nl/en/about-vu/divisions/university-library/more-about/decolonization-and-a-more-inclusive-library) to make such terms invisible in the catalogue while not removing them, so that they can still be used for research purposes. In this way, the project tries to contribute to a more inclusive library environment for diverse users.
