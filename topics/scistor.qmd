...
| Default Policies within ITvO: <br>  - Daily snapshots kept for 1 week (1d:1w) <br>  - Weekly snapshots kept for 4 weeks (1w:4w) | Automatic daily backups around midnight               |
...
The configurtion is as follows:
...
Linux users outside campus can follow the prevuios SFTP explanation.
