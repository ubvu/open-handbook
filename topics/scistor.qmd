...
SciStor is hosted by IT for Research (ITvO) on VU Amsterdam campus enabling a high-speed connection to lab equipment, laptops and workstations, the [BAZIS HPC cluster](./bazis.qmd) and [SciCloud](./scicloud.qmd). It can also be accessed off-campus. 
...
If activated, backups will be made using the 'snapshot' technique.  The backup data is stored at an off-campus datacenter to ensure your data is protected against disasters.
