...
SciStor is hosted by IT for Research (ITvO) on the VU campus enabling a high-speed connection to lab equipment, laptops and workstations, the [ADA HPC cluster](/tools/ada/index.qmd) and [SciCloud](../topics/scicloud.qmd). It can also be accessed off-campus.
...
Although SciStor is most useful on campus you can also [access your shares off-campus](/manuals/scistor/scistor-connection.qmd#off-campus-access).
