...
At VU Amsterdam, we strive to make our research data [FAIR](../topics/fair-principles.qmd). When datasets are archived in a repository provided by VU Amsterdam ([Yoda](https://publication.yoda.vu.nl/) or [DataverseNL](/tools/dataversenl/index.qmd), the following requirements apply:
