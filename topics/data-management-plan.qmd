...
| **Data Stage** | **Dataset Description**      | **Data Type**        | **File Format** |
| -------------- | ---------------------------- | -------------------- | --------------- |
| Raw data       | Interviews                   | Audio recordings     | MP3             |
|                | Spectrographic analysis      | Tabular data         | CSV             |
| Processed data | Interview transcripts        | Text documents       | DOCX            |
|                | Data spreadsheet             | Statistical data     | SAV (SPSS)      |
| Analysed data  | Regression graphic           | Image                | PNG             |
|                | Summary data table           | Text documents       | DOCX            |
| Other          | Poster presentation          | Presentation         | PPS             |
|                | Project website              | Web content          | HTML            |
|                | Analysis code                | Source code          | PY              |
...
If you have questions about working with personal data in research, please get in touch with the Privacy Champion of your faculty. The 🔒 [overview of Privacy Champions](https://vu.nl/en/employee/policy-and-organisation/privacy-champions-information) can be found on VU Amsterdam website. Make sure to contact your Privacy Champion in the following situations:
...
If your research data contains personal data and you're unsure about which data may be published, please contact your 🔒 [Privacy Champion](https://vu.nl/en/employee/policy-and-organisation/privacy-champions-information).
