...
For every step of your data analysis, good [data documentation](https://libguides.vu.nl/rdm/data-documentation) is necessary.
...
For every step of your data cleaning, good [documentation](https://libguides.vu.nl/rdm/data-documentation) and clarifying the [data provenance](https://libguides.vu.nl/rdm/data-provenance) is necessary.
...
If you use software for analysing personal or otherwise sensitive data, you need a processing agreement with the developer if the software does not run locally. You can contact your :lock: [Privacy Champion](https://vu.nl/en/employee/privacy-and-information-security/privacy-champions-information) if you are not sure if you need one, and for help to set up a processing agreement.
...
Several options are detailed below. :lock: [Contact IT for Research](https://services.vu.nl/esc?id=sc_cat_item&sys_id=4e079166978d5950e553359fe153afc5) for advice on which solution could best fit your workflow

#### High Performance Computing (HPC)

![](../public/noaa-ibmsupercomputer.gif)
...
IT for Research (ITvO) offers a virtual server environment where you can run your own server (Linux or Windows). ITvO installs the basic operating system and you are free to install needed software. Web services can be made accessible on the internet. You can find more information and a request form on the :lock: [VU service portal](https://services.vu.nl/esc?id=emp_taxonomy_topic&topic_id=d80aee1f97cf09d0e553359fe153afd7)
...
Sometimes your workload needs dedicated hardware. ITvO offers the option to host your own server hardware in our on-campus data center. Please :lock: [Contact IT for Research](https://services.vu.nl/esc?id=sc_cat_item&sys_id=4e079166978d5950e553359fe153afc5) to discuss possibilities.
