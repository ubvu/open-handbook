...
1. [DataverseNL](/tools/dataversenl/index.qmd) - an online platform for the publication of citable research data in a semi-open environment. DataverseNL allows users to link publications to datasets directly, and to share the data through online archives such as DANS.
...
2. [Yoda](/tools/yoda/index.qmd) - besides [active storage](../topics/data-storage.qmd), Yoda also has an archive function: the vault. You can use the vault in two ways:
