...
Vrije Universiteit Amsterdam is providing a range of data management solutions and support services, offered by various departments and support teams, who collaborate in the [Network Research Data Support](https://vu.nl/en/about-vu/more-about/network-research-data-support-nerds) (NeRDS). This page lists the services and support available.

## Research Data and Software Management tools

The video `Research Data Management, Tools and services` below shows the main functionality of a subset of the tools and services provided by NeRDS.
...
The image below displays all services and tools provided by NeRDS.
...
## Research Data support services and teams
...
On the [Training page](../trainings.qmd) you will find a complete overview of trainings and workshops provided by VU support staff. The page also contains information about open science games that you can set up yourself.
