...
3. Select the following template: '1 - VU DMP template 2021 (NWO & ZonMw certified) v1.4'.
4. Click 'Create'.

![Screenshot of a form for creating a data management plan, asking for the research project and what template you would like to use.](../public/DMPonline-CreatePlan-VU.png)
...
![Screenshot of a form for creating a GDPR registration, asking for the research project and what template you would like to use.](../public/DMPonline-CreatePlan-GDPRform.png)
