...
::: {.callout-note}
Follow these steps as well if you receive funding from NWO, ZonMw or ERC (see also below).
:::
...
![A screenshot highlighting to not use VU Amsterdam GDPR Registration form](../public/DMPonline-CreatePlan-v1.5-DONOTUSEGDPRform-20260326.png)
...
However, it is also possible to use other templates in DMPonline. If your funder or partner organisation requires you to use a certain template, it is possible to select that template in DMPonline. Please follow the steps below to select a funder's template.

1. On your dashboard, click on `Create plan`.
2. Enter the title of your research project (you don't have to select the check box for mock testing).
3. Select the template of your funder from the list.
4. Click `Create`.

![Screenshot of a form for creating a data management plan, showing a list of funder templates.](../public/DMPonline-CreatePlan-Funder-20260326.png)
...
If you work with personal data, you need to [register your processing activities](https://rdm.vu.nl/guides/comply-with-gdpr.html#register-your-processing-activities). If you don't need to write a (new) DMP, you can use the `VU GDPR registration form for research v1.1`. Your faculty's 🔒 [Privacy Champion](https://vu.nl/en/employee/policy-and-organisation/privacy-champions-information) can help you with your registration.
...
The agreement can include a section on who is ultimately responsible for the data and whether the data will be shared afterwards or whether certain restrictions on re-use apply. These restrictions can also be related to copyright issues or pending patent requests. [IXA](https://www.ixa.nl/for-researchers/collaborations/) can help you to draw up a consortium agreement. The [RDM Support Desk](mailto:rdm@vu.nl) at the University Library can also help with questions about legal matters.

If you are working with personal data, GDPR requires that all parties working with the data sign a joint controller agreement. You can ask your 🔒 [Privacy Champion](https://vu.nl/en/employee/policy-and-organisation/privacy-champions-information) for advice about this. For multi-centre clinical research, a [Clinical Trial Agreement](https://english.ccmo.nl/investigators/standard-research-file-for-research-subject-to-the-dutch-wmo-act/k-other-documents/k3-clinical-trial-agreements) is recommended.
