...
The VU is committed to support research that meets the highest requirements of replicability and transparency. The [FAIR data principles](https://www.force11.org/group/fairgroup/fairprinciples) (see also [Overview]((../topics/fair-principles.qmd)), the purpose of which is to render research data Findable, Accessible, Interoperable and Reusable, the General Data Protection Regulation (GDPR) and the principles of Open Science are at the foundation of the Research Data Management (RDM) policy of the VU.
...
​The VU has a number of [confidential counsellors](https://vu.nl/en/about-vu/more-about/academic-integrity) who handle academic integrity issues.
