...
![A screenshot highlighting to not use VU Amsterdam GDPR Registration form](../public/DMPonline-CreatePlan-VU-DONOTUSEGDPRform.png)
...
![Screenshot of a filled out form for creating a data management plan, with example data included.](/public/DMPonline-CreatePlan-Empty.png)
