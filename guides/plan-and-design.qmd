...
If you are working with personal data, GDPR requires that all parties working with the data sign a joint controller agreement. You can ask your 🔒 [Privacy Champion](https://vu.nl/en/employee/privacy-and-information-security/privacy-champions-information) for advice about this. For multi-centre clinical research, a [Clinical Trial Agreement](https://english.ccmo.nl/investigators/clinical-investigations-with-medical-devices/standard-research-file-medical-devices/k-other-documents/k3-clinical-trial-agreements) is recommended.
