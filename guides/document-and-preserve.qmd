...
![A Scriberia sketch about archiving and storage](https://libapps-eu.s3.amazonaws.com/accounts/144379/images/storage-archiving.jpg)
...
* data contain material that is sensitive, for example personal data in the sense of the [GDPR](https://libguides.vu.nl/rdm/gdpr-privacy), like consent forms, voice recordings, DNA data; state secrets; data that are sensitive to competition in a commercial sense. These data need to be separated from other data and archived securely
...
* Raw or cleaned data (if the cleaned data has been archived, the [provenance](https://libguides.vu.nl/rdm/data-provenance) documentation is also required)
* [Project documentation](https://libguides.vu.nl/rdm/data-documentation)
* [Codebook](https://libguides.vu.nl/rdm/codebooks) or [protocol](https://libguides.vu.nl/rdm/data-collection#s-lg-box-wrapper-17896154)
* [Logbook or lab journal](https://libguides.vu.nl/rdm/data-provenance) (when available, dependent on the discipline)
...
See the section [Metadata](https://libguides.vu.nl/rdm/metadata) for more information about documenting your data.

Depending on the research project it may be that more than one dataset is stored in more than one repository. Make sure that each consortium partner that collects data also stores all necessary data that is required for transparency and verification. A [Consortium Agreement](https://libguides.vu.nl/rdm/collaboration) and [Data Management Plan](https://libguides.vu.nl/rdm/dmp) will include information on who is responsible for archiving the data.
...
1. [FAIR data principles](https://libguides.vu.nl/rdm/overview#s-lg-box-wrapper-17896126): the set of principles (Findable, Accessible, Interoperable, Reusable) for data exchange.
...
![A low resolution screenshot of a spreadsheet](https://libapps-eu.s3.amazonaws.com/accounts/46351/images/pivot-table-layout-in-excel-2003.gif)
...
If you want to archive your dataset in such a way that it is compatible with the FAIR-principles, you can use the information in this [practical guide](https://libguides.vu.nl/ld.php?content_id=31290272) which describes how to implement the FAIR data policy and [this table](https://libguides.vu.nl/ld.php?content_id=31290289) which matches metadata fields from different systems (these documents were written for the Faculty of Behavioural and Movement Sciences).
