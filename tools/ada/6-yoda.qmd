...
## Configuration
To use iCommands, a [configuration file](/tools/yoda/yoda_using_icommands.qmd#configuration) is required in your home directory. This file contains the necessary connection settings for accessing Yoda.
