...
## Configuration
To use iCommands, a [configuration file](/tools/yoda/yoda_using_icommands.qmd#environment-file) is required in your home directory. This file contains the necessary connection settings for accessing Yoda.

## Basic iCommands
First use the `iinit` command to connect. You will need a Yoda [Data Access Password](/tools/yoda/yoda_dap.qmd). 
