...
Git is pre-installed on every login/inter/compute node by default. If you need a specific release of git, use `$ module spider git` to check out all installed versions.
