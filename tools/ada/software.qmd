...
New to Lmod? Start with the [Carpentries HPC modules lesson](https://carpentries-incubator.github.io/hpc-intro/15-modules.html) for a friendly walkthrough of the core concepts.
:::
...
- [Carpentries HPC modules lesson](https://carpentries-incubator.github.io/hpc-intro/15-modules.html)
...
- [Basic usage of Pixi](https://pixi.prefix.dev/latest/getting_started/)
...
Skim the official [virtualenv documentation](https://virtualenv.pypa.io/en/latest/) for tips on creating and managing virtual environments.
:::
