...
Couldn’t find an answer to your question yet? The [Qualtrics website](https://www.qualtrics.com/support/)￼provides extensive tutorials and guidance on how to use the platform.
...
Another login method than `Vrije Universiteit SSO` was used. Go to the [login page](https://vuamsterdam.eu.qualtrics.com), choose: `Vrije Universiteit SSO` and log in with your VU account credentials (email address and password). See also the [Quick Start](https://rdm.vu.nl/topics/qualtrics.html#creating-and-accessing-user-accounts) for more information on creating a new account. 
