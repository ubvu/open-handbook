...
**Please note:** Qualtrics is intended for the collection and management of survey data and should not be used for long-term data storage. Please ensure that raw data and analysis results are transferred to an appropriate data storage solution for long-term safeguarding and archiving. You can contact the [RDM support desk](mailto:rdm@vu.nl) if you require advice on how to store your data appropriately.  
