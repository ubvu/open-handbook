...
![Check for DANS compliance](/public/tools/yoda/arch-compliance-dans.png){width=300}
...
You will be presented with a choice to copy or move the dataset:

![Submit, copy or move](/public/tools/yoda/arch-submit-question.png)

If you are not planning to work further on the dataset after archiving/publication, choose move. Note that you can always copy the dataset back from the Vault to Research space later.
...
If the status of your data package changes you will receive a notification in the portal. You can also choose to get [notifications via email](/tools/yoda/notifications.qmd).
