...
The iCommands are installed on the [ADA](/tools/ada/index.qmd) and [Snellius](/topics/snellius.qmd) HPC clusters and can be used to transfer data to and from Yoda. Make sure to create the [irods environment file](#environment-file) first. 
