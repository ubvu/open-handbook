...
If you don't have access to a Windows machine, connect to [Azure Virtual Desktop (AVD)](https://windows.cloud.microsoft/spa-signin-oidc#/devices) and follow the [instructions](./scistor-connection.qmd#windows) for mounting a share in Windows.
...
```
::: {.callout-note}
Be aware that `IT-ITVO-Scistor-Demo` is a share used to write this documentation,
please replace this with your own share.
:::
