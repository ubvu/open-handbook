...
If you don't have access to a Windows machine, connect to [Azure Virtual Desktop (AVD)](https://windows.cloud.microsoft/spa-signin-oidc#/devices) and follow the [instructions](./quick_start.qmd#windows) for mounting a project folder in Windows.
...
Linux works similarly to macOS, but the mount path depends on where you choose to mount your project folder. This example follows the default suggestion in [the handbook](./quick_start.qmd#other-linux-workstations).
