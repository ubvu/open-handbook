...
Although SciStor is most useful on campus you can also access your shares off-campus via [EduVPN](https://vu.eduvpn.nl/).
...
[SciCloud](/tools/scicloud/index.qmd) virtual servers are provisioned with a 20 to 50GB local disk. A SciStor share can be directly mounted on the server to increase storage for your application or directly access your source data for analysis.
