...
The VU has a contract with SURF for the usage of Snellius. Every VU researcher or master student can request Snellius SBUs (System Billing Units). The total amount available to the VU is limited however, you can request up to 500.000 CPU and/or 300.000 GPU SBUs per person, per year.

The [SURF wiki](https://servicedesk.surf.nl/wiki/spaces/WIKI/pages/300974109/Accounting) provides some guidance on estimating the amount of SBUs you need. We recommend you start with the default 50.000 CPU and/or GPU SBUs. You can use the same form to request a top-up if you run out.
