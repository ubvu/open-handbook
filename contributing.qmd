...
![Allow GitHub sign in](/public/vscode/contr-vscode-cloneallow.png) - If you have never signed in with Git before you will be asked to do so. Click Allow.
...
VS Code will automatically switch to the branch. You can always see the branch you are working on in the bottom left of the Window. ![Branch name](/public/vscode/contr-vscode-viewbranch.png)
...
![Visual editor](/public/vscode/contr-vscode-quartopreview.png) - To use the visual editor right-click anywhere in the document you are working on, or use `CTRL+SHIFT+F4`
