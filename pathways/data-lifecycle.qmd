...
*   [](https://vu.nl/en/about-vu/more-about/off-campus-access)[Grant office](https://vu.nl/en/about-vu/more-about/vu-grants-office)
...
// JavaScript Document $(function() { $('.dialogMouse').each(function() { var $link=$(this); var p = $('#img\_research\_data\_service').position(); var $coords=$link.attr('coords').split(',') var $leftextra = parseInt($coords\[0\])-parseInt($coords\[2\]); var $topextra = parseInt($coords\[1\])+parseInt($coords\[2\]); var $dialog = $("#"+$link.attr('ref')) .dialog({ autoOpen: false, resizable: false, width:250, minHeight:20, dialogClass: "no-close" }); $link.mouseover(function() { $dialog.dialog("option","position",{ my: "left top", at: "left+"+$leftextra+" top+"+$topextra, of: $('#img\_research\_data\_service') }) $dialog.dialog("open"); }).mouseout(function() { $dialog.dialog("close"); }); }); //$(".ui-dialog-titlebar").hide(); });
...
*   [](https://vu.nl/en/about-vu/more-about/off-campus-access)[Bazis HPC cluster computing](https://services.vu.nl/esc?id=kb_article&sysparm_article=KB0012830): access to your own linux computational cluster at the VU
...
![](//s3.amazonaws.com/libapps/accounts/62029/images/surf_sara.png)
