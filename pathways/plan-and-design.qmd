...
4.  Where will the data be stored during the research?
6.  After the project has been completed, how will the data be stored for the long term and made available for the use by third parties? To whom will the data be accessible?
8.  Which facilities (ICT, (secure) archive, refrigerators or legal expertise) do you expect will be needed for the storage of data during the research and after the research? Are these available?
